...
const teamData: Record<string, {
  ...
  abhishek: {
    ...
    firstName: "ABHISHEK",
    lastName: "SONNAKULA",
    role: "Founding Engineer / Senior Software Engineer (Full Stack)",
    tagline: "Founding engineer building scalable backend systems, spatial intelligence platforms, and enterprise-grade AI solutions.",
    heroVideo: bgVideoAbhishek,
    portrait: partner2Portrait,
    bioHeading: ["Full Stack", "Developer"],
    bio: [
      "Founding Engineer and Senior Software Engineer with 5+ years of experience building scalable, high-performance software systems. Strong expertise in backend architecture, full-stack development, and cloud-native platforms.",
      "Hands-on work across Spatial Intelligence, AI-driven Visual Positioning Systems (VPS), on-device AI/ML processing, fintech payments, blockchain platforms, AR systems, and enterprise insurance applications.",
      "Experienced in taking products from idea to production, owning system design end-to-end, and delivering secure, enterprise-ready deployments in startup and enterprise environments.",
    ],
    services: [
    ...
    capabilities: [
      { category: "Backend & Systems", items: ["Node.js", "NestJS", "Express.js", "Python", "FastAPI", "REST APIs", "System Architecture"] },
      { category: "Frontend & Mobile", items: ["React.js", "React Native", "Flutter"] },
      { category: "AI & Spatial Computing", items: ["Visual Positioning Systems (VPS)", "On-device AI/ML", "Spatial Intelligence", "Augmented Reality"] },
      { category: "Cloud & DevOps", items: ["AWS", "GCP", "Docker", "CI/CD Pipelines", "GitHub Actions", "Terraform", "Secure On-Prem Deployments"] },
      { category: "Databases & Messaging", items: ["MongoDB", "MySQL", "Redis", "RabbitMQ"] },
    ],
    experience: [
      {
        company: "MultiSet AI",
        ...
        bullets: [
          "Designed and developed scalable backend services for spatial intelligence, localization, and multi-source mapping pipelines.",
          "Built and optimized on-device AI/ML model processing for Android and iOS SDKs, enabling offline and low-latency inference.",
          "Implemented secure on-premise deployments inside customer-owned cloud accounts (AWS).",
          "Worked across backend systems, cloud infrastructure, and product architecture as a core founding team member.",
        ],
      },
      {
        company: "HTC Global Services (Client: American Family Insurance)",
        period: "2023 - 2024",
        title: "Senior Software Engineer",
        bullets: [
          "Developed and maintained backend APIs for the core AUTO insurance domain.",
          "Handled core business logic layers supporting policy lifecycle, coverage, and insurance workflows.",
          "Performed defect analysis, monitoring, and performance optimization for critical systems.",
        ],
      },
      {
        company: "Rydeum (ComTek)",
        period: "2022 - 2023",
        title: "Senior Software Engineer",
        bullets: [
          "Built backend services for a crypto-based mobile platform.",
          "Designed APIs supporting wallet operations, transactions, and secure integrations.",
          "Managed Dockerized deployments and cloud infrastructure.",
        ],
      },
      {
        company: "HONC",
        ...
        bullets: [
          "Owned backend architecture, API design, and system scalability.",
          "Led and mentored an 8-member engineering team across backend and frontend.",
          "Built location-based services and IoT-enabled wash point automation.",
        ],
      },
      {
        company: "XLenz",
        ...
        bullets: [
          "Developed backend APIs for AR-based web and mobile applications.",
          "Integrated AR SDKs such as Wikitude and Vuforia.",
          "Built platform extensions integrating AR systems with Shopify and CRM tools.",
        ],
      },
    ],
    projects: [
      {
        title: "MultiSet – Spatial Intelligence & Visual Positioning Platform",
        role: "Founding Engineer (Full Stack)",
        description: "AI-driven spatial intelligence platform combining Visual Positioning System (VPS), 3D mapping, and enterprise-grade deployment models.",
        value: "Enabling offline and low-latency spatial inference on mobile devices with secure, customer-owned cloud deployments.",
        features: [
          "Scalable backend services for spatial intelligence and multi-source mapping pipelines",
          "On-device AI/ML model processing for Android and iOS SDKs",
          "Secure on-premise deployments inside customer-owned AWS accounts",
        ],
        techStack: ["Python", "FastAPI", "Node.js", "MongoDB", "AWS"],
      },
      {
        title: "Enterprise AUTO Insurance Core Backend Services",
        role: "Senior Software Engineer",
        description: "Enterprise backend systems supporting core AUTO insurance business workflows for American Family Insurance.",
        value: "Delivered stable, production-grade backend services supporting policy lifecycle, coverage, and insurance workflows.",
        features: [
          "Backend APIs for the core AUTO insurance domain",
          "Core business logic layers supporting policy lifecycle and coverage",
          "Performance optimization and monitoring for critical systems",
        ],
        techStack: ["Node.js", "Datadog", "Optimizely"],
      },
      {
        title: "Crypto-Based Infrastructure & Payments Platform",
        role: "Senior Software Engineer",
        description: "Backend platform bridging blockchain networks with computational resources at Rydeum.",
        value: "Built secure crypto platform backend handling wallet operations, transactions, and third-party integrations.",
        features: [
          "APIs supporting wallet operations, transactions, and secure integrations",
          "Third-party integrations including issuance portals and payment gateways",
          "Dockerized deployments and cloud infrastructure management",
        ],
        techStack: ["Node.js", "NestJS", "MongoDB", "Redis", "AWS"],
      },
      {
        title: "HONC – Doorstep Car Care Platform",
        role: "Software Engineer → Team Lead",
        description: "End-to-end engineering for a doorstep car care and auto-tech platform.",
        value: "Owned backend architecture and led an 8-member team, delivering IoT-enabled automation and location-based services.",
        features: [
          "Backend architecture, API design, and system scalability",
          "Location-based services and IoT-enabled wash point automation",
          "CI/CD pipelines and release cycle management",
        ],
        techStack: ["Node.js", "MongoDB", "Express", "React", "Redis", "RabbitMQ", "AWS"],
      },
      {
        title: "AR Platform & Commerce Integrations",
        role: "Software Developer",
        description: "Backend and platform development for augmented reality applications at XLenz.",
        value: "Enabled cross-platform AR experiences by bridging mobile and Unity environments with Shopify and CRM integrations.",
        features: [
          "Backend APIs for AR-based web and mobile applications",
          "AR SDK integrations (Wikitude, Vuforia)",
          "Platform extensions integrating AR with Shopify and CRM tools",
        ],
        techStack: ["Node.js", "MongoDB", "Express", "React", "Flutter", "Unity (C#)"],
      },
      {
        title: "Bankful – Unified Payments Engine",
        role: "Backend / Full Stack Developer",
        description: "Unified payments engine for e-commerce platforms like Shopify and Wix.",
        value: "Built a multi-gateway payments engine enabling centralized transaction management and fraud analysis.",
        features: [
          "Multi-gateway payments engine for e-commerce platforms",
          "Centralized transaction management and fraud analysis",
          "Secure and scalable payment APIs for fintech use cases",
        ],
